...
var f, S, g, _, at, Ft, D, J, ft, X, Dt, Q, At, O, ut = !1, Bt = !1, Ht = [], it, H, $t, Ut, de, he, bt, st, St, Tt = !1, Pt = !1, Rt, I, qt = [], Jt = !1, Wt = [], Lt = typeof document < "u", xt = me, pe = Ct || V ? "cssFloat" : "float", je = Lt && !ve && !me && "draggable" in document.createElement("div"), Te = function() {
  if (Lt) {
    if (V)
      return !1;
...
p.prototype = /** @lends Sortable.prototype */
{
  ...
  _prepareDragStart: function(t, e, n) {
    ...
    if (n && !f && n.parentNode === r) {
      ...
      if (_ = r, f = n, S = f.parentNode, at = f.nextSibling, Ft = n, At = a.group, p.dragged = f, it = {
        ...
        we(f, d.trim(), Vt);
      }), E(l, "dragover", rt), E(l, "mousemove", rt), E(l, "touchmove", rt), E(l, "mouseup", i._onDrop), E(l, "touchend", i._onDrop), E(l, "touchcancel", i._onDrop), se && this.nativeDraggable && (this.options.touchStartThreshold = 4, f.draggable = !0), x("delayStart", this, {
        evt: t
  ...
  _onTouchMove: function(t) {
    if (it) {
      var e = this.options, n = e.fallbackTolerance, i = e.fallbackOffset, r = t.touches ? t.touches[0] : t, a = g && ct(g, !0), l = g && a && a.a, s = g && a && a.d, u = xt && I && ce(I), d = (r.clientX - it.clientX + i.x) / (l || 1) + (u ? u[0] - qt[0] : 0) / (l || 1), c = (r.clientY - it.clientY + i.y) / (s || 1) + (u ? u[1] - qt[1] : 0) / (s || 1);
      if (!p.active && !ut) {
  ...
  _onDragStart: function(t, e) {
    ...
    }), !e && R(f, r.dragClass, !0), e ? (Bt = !0, n._loopId = setInterval(n._emulateDragOver, 50)) : (b(document, "mouseup", n._onDrop), b(document, "touchend", n._onDrop), b(document, "touchcancel", n._onDrop), i && (i.effectAllowed = "move", r.setData && r.setData.call(n, i, f)), E(document, "drop", n), h(f, "transform", "translateZ(0)")), ut = !0, n._dragStartId = Xt(n._dragStarted.bind(n, e, t)), E(document, "selectstart", n), bt = !0, yt && h(document.body, "user-select", "none");
  },
  ...
  _onDragOver: function(t) {
    ...
    function k(vt, xe) {
      x(vt, v, z({
        ...
        onMove: function(ae, Ne) {
          return Nt(_, e, f, i, ae, C(ae), t, Ne);
        },
        changed: B
      }, xe));
    }
    ...
    function A(vt) {
      return k("dragOverCompleted", {
        insertion: vt
      }), vt && (d ? u._hideClone() : u._showClone(v), v !== m && (R(f, O ? O.options.ghostClass : u.options.ghostClass, !1), R(f, l.ghostClass, !0)), O !== v && v !== p.active ? O = v : v === p.active && O && (O = null), m === v && (v._ignoreWhileAnimating = n), v.animateAll(function() {
        k("dragOverAnimationComplete"), v._ignoreWhileAnimating = null;
      }), v !== m && (m.animateAll(), m._ignoreWhileAnimating = null)), (n === f && !f.animated || n === e && !n.animated) && (st = null), !l.dragoverBubble && !t.rootEl && n !== document && (f.parentNode[N]._isOutsideThisEl(t.target), !vt && rt(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), w = !0;
    }
    function B() {
    ...
    if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), n = W(n, l.draggable, e, !0), k("dragOver"), p.eventCanceled) return w;
    ...
    if (Bt = !1, u && !l.disabled && (d ? c || (a = S !== _) : O === this || (this.lastPutMode = At.checkPull(this, u, f, t)) && s.checkPut(this, u, f, t))) {
      ...
      if (!M || Qe(t, y, this) && !M.animated) {
        ...
        r = C(n);
        var G = 0, nt, ht = f.parentNode !== e, F = !$e(f.animated && f.toRect || i, n.animated && n.toRect || r, y), pt = y ? "top" : "left", K = fe(n, "top", "top") || fe(f, "top", "top"), gt = K ? K.scrollTop : void 0;
        st !== n && (nt = r[pt], Tt = !1, Pt = !F && l.invertSwap || ht), G = Je(t, n, r, y, F ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Pt, st === n);
        var $;
        if (G !== 0) {
          var ot = Y(f);
          do
...
function Qe(o, t, e) {
  var n = C(oe(e.el, e.options.draggable)), i = Se(e.el, e.options, g), r = 10;
...
var Qt = ye(function(o, t, e, n) {
  if (t.scroll) {
    ...
    var c = 0, m = Et;
    do {
      var y = m, v = C(y), w = v.top, k = v.bottom, j = v.left, A = v.right, B = v.width, M = v.height, et = void 0, G = void 0, nt = y.scrollWidth, ht = y.scrollHeight, F = h(y), pt = y.scrollLeft, K = y.scrollTop;
      y === s ? (et = B < nt && (F.overflowX === "auto" || F.overflowX === "scroll" || F.overflowX === "visible"), G = M < ht && (F.overflowY === "auto" || F.overflowY === "scroll" || F.overflowY === "visible")) : (et = B < nt && (F.overflowX === "auto" || F.overflowX === "scroll"), G = M < ht && (F.overflowY === "auto" || F.overflowY === "scroll"));
      var gt = et && (Math.abs(A - i) <= a && pt + B < nt) - (Math.abs(j - i) <= a && !!pt), $ = G && (Math.abs(k - r) <= a && K + M < ht) - (Math.abs(w - r) <= a && !!K);
      if (!T[c])
