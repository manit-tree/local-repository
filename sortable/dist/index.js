...
var nt = et(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), Xt = et(/Edge/i), _e = et(/firefox/i), Mt = et(/safari/i) && !et(/chrome/i) && !et(/android/i), Fe = et(/iP(ad|od|hone)/i), Re = et(/chrome/i) && et(/android/i), ke = {
  capture: !1,
  passive: !1
};
function y(o, t, e) {
...
function C(o, t, e, n, i) {
  if (!(!o.getBoundingClientRect && o !== window)) {
    var r, a, l, s, u, d, c;
    if (o !== window && o.parentNode && o !== Q() ? (r = o.getBoundingClientRect(), a = r.top, l = r.left, s = r.bottom, u = r.right, d = r.height, c = r.width) : (a = 0, l = 0, s = window.innerHeight, u = window.innerWidth, d = window.innerHeight, c = window.innerWidth), (t || e) && o !== window && (i = i || o.parentNode, !nt))
      do
...
function wt(o, t, e, n) {
  for (var i = 0, r = 0, a = o.children; r < a.length; ) {
    if (a[r].style.display !== "none" && a[r] !== g.ghost && (n || a[r] !== g.dragged) && z(a[r], e.draggable, o, !1)) {
      if (i === t)
        return a[r];
      i++;
    }
...
function Be(o, t) {
  return function() {
    if (!Pt) {
      ...
      e.length === 1 ? o.call(n, e[0]) : o.apply(n, e), Pt = setTimeout(function() {
        Pt = void 0;
      }, t);
    }
  };
  ...
  return {
    ...
    animateAll: function(n) {
      ...
      o.forEach(function(l) {
        var s = 0, u = l.target, d = u.fromRect, c = C(u), p = u.prevFromRect, E = u.prevToRect, b = l.rect, S = ht(u, !0);
        ...
        (b.top - c.top) / (b.left - c.left) === (d.top - c.top) / (d.left - c.left) && (s = cn(b, p, E, i.options)), oe(c, d) || (u.prevFromRect = d, u.prevToRect = c, s || (s = i.options.animation), i.animate(u, b, c, s)), s && (r = !0, a = Math.max(a, s), clearTimeout(u.animationResetTimer), u.animationResetTimer = setTimeout(function() {
...
var pt = [], re = {
  ...
  getEventProperties: function(t, e) {
    ...
    return pt.forEach(function(i) {
      typeof i.eventProperties == "function" && U(n, i.eventProperties.call(e[i.pluginName], t));
    }), n;
  },
...
function At(o) {
  var t = o.sortable, e = o.rootEl, n = o.name, i = o.targetEl, r = o.cloneEl, a = o.toEl, l = o.fromEl, s = o.oldIndex, u = o.newIndex, d = o.oldDraggableIndex, c = o.newDraggableIndex, p = o.originalEvent, E = o.putSortable, b = o.extraEventProperties;
  if (t = t || e && e[R], !!t) {
    var S, x = t.options, L = "on" + n.charAt(0).toUpperCase() + n.substr(1);
    window.CustomEvent && !nt && !Xt ? S = new CustomEvent(n, {
      bubbles: !0,
      cancelable: !0
    }) : (S = document.createEvent("Event"), S.initEvent(n, !0, !0)), S.to = a || e, S.from = l || e, S.item = i || e, S.clone = r, S.oldIndex = s, S.newIndex = u, S.oldDraggableIndex = d, S.newDraggableIndex = c, S.originalEvent = p, S.pullMode = E ? E.lastPutMode : void 0;
    var P = J(J({}, b), Yt.getEventProperties(n, t));
    for (var Y in P)
      S[Y] = P[Y];
    e && e.dispatchEvent(S), x[L] && x[L].call(t, S);
  }
}
...
var f, I, v, O, dt, Ut, T, at, bt, K, Ft, rt, Ht, F, vt = !1, Qt = !1, Jt = [], ft, $, ae, le, Ie, Ne, It, gt, Rt, kt = !1, Gt = !1, $t, k, se = [], pe = !1, te = [], ne = typeof document < "u", Wt = Fe, xe = Xt || nt ? "cssFloat" : "float", hn = ne && !Re && !Fe && "draggable" in document.createElement("div"), We = function() {
  if (ne) {
    if (nt)
      return !1;
  ...
  var n = h(t), i = parseInt(n.width) - parseInt(n.paddingLeft) - parseInt(n.paddingRight) - parseInt(n.borderLeftWidth) - parseInt(n.borderRightWidth), r = wt(t, 0, e), a = wt(t, 1, e), l = r && h(r), s = a && h(a), u = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + C(r).width, d = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + C(a).width;
  if (n.display === "flex")
...
function g(o, t) {
  ...
  this.el = o, this.options = t = U({}, t), o[R] = this;
  var e = {
    group: null,
    sort: !0,
    disabled: !1,
...
g.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (_n(n), !f && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || i.disabled) && !u.isContentEditable && !(!this.nativeDraggable && Mt && s && s.tagName.toUpperCase() === "SELECT") && (s = z(s, i.draggable, n, !1), !(s && s.animated) && Ut !== s)) {
  ...
  _prepareDragStart: function(t, e, n) {
    ...
    if (n && !f && n.parentNode === r) {
      var u = C(n);
      if (O = r, f = n, I = f.parentNode, dt = f.nextSibling, Ut = n, Ht = a.group, g.dragged = f, ft = {
        target: f,
        clientX: (e || t).clientX,
        clientY: (e || t).clientY
      }, Ie = ft.clientX - u.left, Ne = ft.clientY - u.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, f.style["will-change"] = "all", s = function() {
        if (B("delayEnded", i, {
          evt: t
        }), g.eventCanceled) {
          i._onDrop();
        ...
        i._disableDelayedDragEvents(), !_e && i.nativeDraggable && (f.draggable = !0), i._triggerDragStart(t, e), X({
          sortable: i,
          name: "choose",
          originalEvent: t
        }), A(f, a.chosenClass, !0);
        ...
        Ye(f, d.trim(), ue);
      }), y(l, "dragover", ct), y(l, "mousemove", ct), y(l, "touchmove", ct), y(l, "mouseup", i._onDrop), y(l, "touchend", i._onDrop), y(l, "touchcancel", i._onDrop), _e && this.nativeDraggable && (this.options.touchStartThreshold = 4, f.draggable = !0), B("delayStart", this, {
        evt: t
  ...
  _triggerDragStart: function(t, e) {
    e = e || t.pointerType == "touch" && t, !this.nativeDraggable || e ? this.options.supportPointer ? y(document, "pointermove", this._onTouchMove) : e ? y(document, "touchmove", this._onTouchMove) : y(document, "mousemove", this._onTouchMove) : (y(f, "dragend", this), y(O, "dragstart", this._onDragStart));
    try {
  ...
  _dragStarted: function(t, e) {
    if (vt = !1, O && f) {
      ...
      var n = this.options;
      !t && A(f, n.dragClass, !1), A(f, n.ghostClass, !0), g.active = this, t && this._appendGhost(), X({
        sortable: this,
        name: "start",
        originalEvent: e
      });
  ...
  _emulateDragOver: function() {
    if ($) {
      this._lastX = $.clientX, this._lastY = $.clientY, je();
      for (var t = document.elementFromPoint($.clientX, $.clientY), e = t; t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint($.clientX, $.clientY), t !== e); )
        e = t;
  ...
  _onTouchMove: function(t) {
    if (ft) {
      var e = this.options, n = e.fallbackTolerance, i = e.fallbackOffset, r = t.touches ? t.touches[0] : t, a = v && ht(v, !0), l = v && a && a.a, s = v && a && a.d, u = Wt && k && Te(k), d = (r.clientX - ft.clientX + i.x) / (l || 1) + (u ? u[0] - se[0] : 0) / (l || 1), c = (r.clientY - ft.clientY + i.y) / (s || 1) + (u ? u[1] - se[1] : 0) / (s || 1);
      if (!g.active && !vt) {
      ...
      if (v) {
        ...
        h(v, "webkitTransform", p), h(v, "mozTransform", p), h(v, "msTransform", p), h(v, "transform", p), ae = d, le = c, $ = r;
      }
  ...
  _appendGhost: function() {
    if (!v) {
      var t = this.options.fallbackOnBody ? document.body : O, e = C(f, !0, Wt, !0, t), n = this.options;
      if (Wt) {
        for (k = t; h(k, "position") === "static" && h(k, "transform") === "none" && k !== document; )
          k = k.parentNode;
        k !== document.body && k !== document.documentElement ? (k === document && (k = Q()), e.top += k.scrollTop, e.left += k.scrollLeft) : k = Q(), se = Te(k);
      }
      v = f.cloneNode(!0), A(v, n.ghostClass, !1), A(v, n.fallbackClass, !0), A(v, n.dragClass, !0), h(v, "transition", ""), h(v, "transform", ""), h(v, "box-sizing", "border-box"), h(v, "margin", 0), h(v, "top", e.top), h(v, "left", e.left), h(v, "width", e.width), h(v, "height", e.height), h(v, "opacity", "0.8"), h(v, "position", Wt ? "absolute" : "fixed"), h(v, "zIndex", "100000"), h(v, "pointerEvents", "none"), g.ghost = v, t.appendChild(v), h(v, "transform-origin", Ie / parseInt(v.style.width) * 100 + "% " + Ne / parseInt(v.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(t, e) {
    ...
    B("setupClone", this), g.eventCanceled || (T = we(f), T.removeAttribute("id"), T.draggable = !1, T.style["will-change"] = "", this._hideClone(), A(T, this.options.chosenClass, !1), g.clone = T), n.cloneId = qt(function() {
      B("clone", n), !g.eventCanceled && (n.options.removeCloneOnHide || O.insertBefore(T, f), n._hideClone(), X({
        sortable: n,
        name: "clone"
      }));
    }), !e && A(f, r.dragClass, !0), e ? (Qt = !0, n._loopId = setInterval(n._emulateDragOver, 50)) : (w(document, "mouseup", n._onDrop), w(document, "touchend", n._onDrop), w(document, "touchcancel", n._onDrop), i && (i.effectAllowed = "move", r.setData && r.setData.call(n, i, f)), y(document, "drop", n), h(f, "transform", "translateZ(0)")), vt = !0, n._dragStartId = qt(n._dragStarted.bind(n, e, t)), y(document, "selectstart", n), It = !0, Mt && h(document.body, "user-select", "none");
  },
  // Returns true - if no further action is needed (either inserted or another condition)
  _onDragOver: function(t) {
    var e = this.el, n = t.target, i, r, a, l = this.options, s = l.group, u = g.active, d = Ht === s, c = l.sort, p = F || u, E, b = this, S = !1;
    if (pe) return;
    function x(_t, $e) {
      B(_t, b, J({
        evt: t,
        ...
        onMove: function(Se, qe) {
          return Kt(O, e, f, i, Se, C(Se), t, qe);
        },
        changed: Y
      }, $e));
    }
    function L() {
      x("dragOverAnimationCapture"), b.captureAnimationState(), b !== p && p.captureAnimationState();
    }
    function P(_t) {
      return x("dragOverCompleted", {
        insertion: _t
      }), _t && (d ? u._hideClone() : u._showClone(b), b !== p && (A(f, F ? F.options.ghostClass : u.options.ghostClass, !1), A(f, l.ghostClass, !0)), F !== b && b !== g.active ? F = b : b === g.active && F && (F = null), p === b && (b._ignoreWhileAnimating = n), b.animateAll(function() {
        x("dragOverAnimationComplete"), b._ignoreWhileAnimating = null;
      }), b !== p && (p.animateAll(), p._ignoreWhileAnimating = null)), (n === f && !f.animated || n === e && !n.animated) && (gt = null), !l.dragoverBubble && !t.rootEl && n !== document && (f.parentNode[R]._isOutsideThisEl(t.target), !_t && ct(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), S = !0;
    }
    function Y() {
      K = N(f), rt = N(f, l.draggable), X({
        sortable: b,
        name: "change",
        toEl: e,
        newIndex: K,
    ...
    if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), n = z(n, l.draggable, e, !0), x("dragOver"), g.eventCanceled) return S;
    if (f.contains(t.target) || n.animated && n.animatingX && n.animatingY || b._ignoreWhileAnimating === n)
      return P(!1);
    if (Qt = !1, u && !l.disabled && (d ? c || (a = I !== O) : F === this || (this.lastPutMode = Ht.checkPull(this, u, f, t)) && s.checkPut(this, u, f, t))) {
      if (E = this._getDirection(t, n) === "vertical", i = C(f), x("dragOverValid"), g.eventCanceled) return S;
      if (a)
        return I = O, L(), this._hideClone(), x("revert"), g.eventCanceled || (dt ? O.insertBefore(f, dt) : O.appendChild(f)), P(!0);
      var D = be(e, l.draggable);
      if (!D || yn(t, E, this) && !D.animated) {
        if (D === f)
          return P(!1);
        if (D && e === t.target && (n = D), n && (r = C(n)), Kt(O, e, f, i, n, r, t, !!n) !== !1)
          return L(), D && D.nextSibling ? e.insertBefore(f, D.nextSibling) : e.appendChild(f), I = e, Y(), P(!0);
        ...
        r = C(n);
        var Z = 0, st, yt = f.parentNode !== e, G = !pn(f.animated && f.toRect || i, n.animated && n.toRect || r, E), Et = E ? "top" : "left", ot = Oe(n, "top", "top") || Oe(f, "top", "top"), St = ot ? ot.scrollTop : void 0;
        ...
        if (Bt !== !1)
          return (Bt === 1 || Bt === -1) && (it = Bt === 1), pe = !0, setTimeout(bn, 30), L(), it && !Dt ? e.appendChild(f) : n.parentNode.insertBefore(f, it ? Dt : n), ot && He(ot, 0, St - ot.scrollTop), I = f.parentNode, st !== void 0 && !Gt && ($t = Math.abs(st - C(n)[Et])), Y(), P(!0);
      }
      if (e.contains(f))
        return P(!1);
    }
  ...
  _offMoveEvents: function() {
    w(document, "mousemove", this._onTouchMove), w(document, "touchmove", this._onTouchMove), w(document, "pointermove", this._onTouchMove), w(document, "dragover", ct), w(document, "mousemove", ct), w(document, "touchmove", ct);
  },
  ...
  _onDrop: function(t) {
    ...
    if (K = N(f), rt = N(f, n.draggable), B("drop", this, {
      evt: t
    }), I = f && f.parentNode, K = N(f), rt = N(f, n.draggable), g.eventCanceled) {
      this._nulling();
      return;
    }
    vt = !1, Gt = !1, kt = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), ge(this.cloneId), ge(this._dragStartId), this.nativeDraggable && (w(document, "drop", this), w(e, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), Mt && h(document.body, "user-select", ""), h(f, "transform", ""), t && (It && (t.cancelable && t.preventDefault(), !n.dropBubble && t.stopPropagation()), v && v.parentNode && v.parentNode.removeChild(v), (O === I || F && F.lastPutMode !== "clone") && T && T.parentNode && T.parentNode.removeChild(T), f && (this.nativeDraggable && w(f, "dragend", this), ue(f), f.style["will-change"] = "", It && !vt && A(f, F ? F.options.ghostClass : this.options.ghostClass, !1), A(f, this.options.chosenClass, !1), X({
      sortable: this,
      name: "unchoose",
      toEl: I,
      newIndex: null,
      ...
      toEl: I,
      originalEvent: t
    })), g.active && ((K == null || K === -1) && (K = bt, rt = Ft), X({
      sortable: this,
      name: "end",
      toEl: I,
      originalEvent: t
  ...
  _nulling: function() {
    B("nulling", this), O = f = I = v = dt = T = Ut = at = ft = $ = It = K = rt = bt = Ft = gt = Rt = F = Ht = g.dragged = g.ghost = g.clone = g.active = null, te.forEach(function(t) {
      t.checked = !0;
    }), te.length = ae = le = 0;
  },
  ...
  destroy: function() {
    B("destroy", this);
    var t = this.el;
    t[R] = null, w(t, "mousedown", this._onTapStart), w(t, "touchstart", this._onTapStart), w(t, "pointerdown", this._onTapStart), this.nativeDraggable && (w(t, "dragover", this), w(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function(e) {
  ...
  _hideClone: function() {
    if (!at) {
      ...
      h(T, "display", "none"), this.options.removeCloneOnHide && T.parentNode && T.parentNode.removeChild(T), at = !0;
    }
  },
  _showClone: function(t) {
    ...
    if (at) {
      ...
      f.parentNode == O && !this.options.group.revertClone ? O.insertBefore(T, f) : dt ? O.insertBefore(T, dt) : O.appendChild(T), this.options.group.revertClone && this.animate(f, T), h(T, "display", ""), at = !1;
    }
  }
};
function vn(o) {
...
function wn(o, t, e) {
  var n = C(wt(e.el, 0, e.options, !0)), i = Ge(e.el, e.options, v), r = 10;
  return t ? o.clientX < i.left - r || o.clientY < n.top && o.clientX < n.right : o.clientY < i.top - r || o.clientY < n.bottom && o.clientX < n.left;
}
function yn(o, t, e) {
  var n = C(be(e.el, e.options.draggable)), i = Ge(e.el, e.options, v), r = 10;
...
function Cn() {
  ...
  return o.prototype = {
    ...
    nulling: function() {
      ee = me = Nt = ve = xt = fe = ce = null, M.length = 0;
    },
...
var de = Be(function(o, t, e, n) {
  if (t.scroll) {
    ...
    var c = 0, p = Nt;
    do {
      var E = p, b = C(E), S = b.top, x = b.bottom, L = b.left, P = b.right, Y = b.width, D = b.height, V = void 0, Z = void 0, st = E.scrollWidth, yt = E.scrollHeight, G = h(E), Et = E.scrollLeft, ot = E.scrollTop;
      ...
      var St = V && (Math.abs(P - i) <= a && Et + Y < st) - (Math.abs(L - i) <= a && !!Et), tt = Z && (Math.abs(x - r) <= a && ot + D < yt) - (Math.abs(S - r) <= a && !!ot);
      if (!M[c])
        for (var ut = 0; ut <= c; ut++)
          M[ut] || (M[ut] = {});
      (M[c].vx != St || M[c].vy != tt || M[c].el !== E) && (M[c].el = E, M[c].vx = St, M[c].vy = tt, clearInterval(M[c].pid), (St != 0 || tt != 0) && (u = !0, M[c].pid = setInterval((function() {
        n && this.layer === 0 && g.active._onTouchMove(ee);
        var Dt = M[this.layer].vy ? M[this.layer].vy * l : 0, it = M[this.layer].vx ? M[this.layer].vx * l : 0;
        typeof d == "function" && d.call(g.dragged.parentNode[R], it, Dt, o, ee, M[this.layer].el) !== "continue" || He(M[this.layer].el, it, Dt);
      }).bind({
        layer: c
      }), 24))), c++;
  ...
  return o.prototype = {
    ...
    dragOverValid: function(e) {
      ...
      if (a.options.swap) {
        ...
        if (i && i !== u) {
          var c = j;
          r(i) !== !1 ? (A(i, d.swapClass, !0), j = i) : j = null, c && c !== j && A(c, d.swapClass, !1);
        }
        l(), n(!0), s();
      }
    },
    drop: function(e) {
      ...
      j && A(j, l.swapClass, !1), j && (l.swap || i && i.options.swap) && r !== j && (a.captureAnimationState(), a !== n && n.captureAnimationState(), Tn(r, j), a.animateAll(), a !== n && n.animateAll());
    },
    nulling: function() {
      j = null;
    }
...
var m = [], W = [], Ct, q, Ot = !1, H = !1, mt = !1, _, Tt, Lt;
function An() {
  function o(t) {
    for (var e in this)
  ...
  return o.prototype = {
    ...
    setupClone: function(e) {
      ...
      if (this.isMultiDrag) {
        for (var r = 0; r < m.length; r++)
          W.push(we(m[r])), W[r].sortableIndex = m[r].sortableIndex, W[r].draggable = !1, W[r].style["will-change"] = "", A(W[r], this.options.selectedClass, !1), m[r] === _ && A(W[r], this.options.chosenClass, !1);
        n._hideClone(), i();
      }
    },
    clone: function(e) {
      var n = e.sortable, i = e.rootEl, r = e.dispatchSortableEvent, a = e.cancel;
      this.isMultiDrag && (this.options.removeCloneOnHide || m.length && q === n && (Pe(!0, i), r("clone"), a()));
    },
    showClone: function(e) {
      var n = e.cloneNowShown, i = e.rootEl, r = e.cancel;
      this.isMultiDrag && (Pe(!1, i), W.forEach(function(a) {
        h(a, "display", "");
      }), n(), Lt = !1, r());
    },
    hideClone: function(e) {
      ...
      this.isMultiDrag && (W.forEach(function(a) {
    ...
    dragOverCompleted: function(e) {
      ...
      if (r) {
        ...
        if (!i)
          if (H || jt(), m.length > 1) {
            var c = Lt;
            a._showClone(n), a.options.animation && !Lt && c && W.forEach(function(p) {
              a.addAnimationState({
                target: p,
                rect: Tt
    ...
    drop: function(e) {
      ...
      if (n) {
        ...
        if (!mt)
          if (c.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), A(_, c.selectedClass, !~m.indexOf(_)), ~m.indexOf(_))
            ...
            if (m.push(_), At({
              ...
              if (~E && ~b && E !== b) {
                var S, x;
                for (b > E ? (x = E, S = b) : (x = b, S = E + 1); x < S; x++)
                  ~m.indexOf(p[x]) || (A(p[x], c.selectedClass, !0), m.push(p[x]), At({
                    sortable: a,
                    rootEl: i,
                    name: "select",
                    targetEl: p[x],
        ...
        if (mt && this.isMultiDrag) {
          if (H = !1, (r[R].options.sort || r !== i) && m.length > 1) {
            var L = C(_), P = N(_, ":not(." + this.options.selectedClass + ")");
            if (!Ot && c.animation && (_.thisAnimationDuration = null), d.captureAnimationState(), !Ot && (c.animation && (_.fromRect = L, m.forEach(function(D) {
        ...
        (i === r || u && u.lastPutMode !== "clone") && W.forEach(function(D) {
    ...
    _deselectMultiDrag: function(e) {
      if (!(typeof mt < "u" && mt) && q === this.sortable && !(e && z(e.target, this.options.draggable, this.sortable.el, !1)) && !(e && e.button !== 0))
        for (; m.length; ) {
          var n = m[0];
          A(n, this.options.selectedClass, !1), m.shift(), At({
    ...
    utils: {
      ...
      select: function(e) {
        ...
        !n || !n.options.multiDrag || ~m.indexOf(e) || (q && q !== n && (q.multiDrag._deselectMultiDrag(), q = n), A(e, n.options.selectedClass, !0), m.push(e));
      },
      /**
